        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" data-accordion="false"
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('pengguna.index') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <span class="badge bg-danger mr-1"><a href=""
                                                            data-toggle="modal"
                                                            data-target="#delete-{{ $user->id }}">Delete</a></span>
                                                    <span class="badge bg-warning mr-1">Lihat</span>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                ...
                <div class="modal-content">
                    <form action="{{ route('pengguna.destroy', $user->id) }}" method="post">
                        ...
                        <div class="modal-body">
                            Yakin akan menghapus <b>{{ $user->username }}</b> ?
                        </div>
